...
*/
    ...
    //Playground Sprites
    var foreground 	= new $.gQ.Animation({imageURL: "./img/battle/stage/foreground.png", type: $.gQ.ANIMATION_VERTICAL});
    var ground 		= new $.gQ.Animation({imageURL: "./img/battle/stage/ground.png"});
    var background1 = new $.gQ.Animation({imageURL: "./img/battle/stage/background1.png"});
    var background2 = new $.gQ.Animation({imageURL: "./img/battle/stage/background2.png"});
    var background3 = new $.gQ.Animation({imageURL: "./img/battle/stage/background3.png"});
    ...
    var cvs = {
        ...
        position: 350,
        adversary: "#abobo",
        animations: [ {animation: new $.gQ.Animation({	imageURL: "./img/battle/cvs/cvs_idle_59x106x6.png",
									numberOfFrame: 6,
									delta: 59,
									rate:240,
									type: $.gQ.ANIMATION_HORIZONTAL | $.gQ.ANIMATION_CALLBACK}),
				deltaX: 0, deltaY: 0, width: 59, height: 106},
            {animation: new $.gQ.Animation({	imageURL: "./img/battle/cvs/cvs_walk_forward_58x106x5.png",
									numberOfFrame: 5,
									delta: 58,
									rate:240,
									type: $.gQ.ANIMATION_HORIZONTAL | $.gQ.ANIMATION_CALLBACK}),
				deltaX: 0, deltaY: 0, width: 58, height: 106},
            {animation: new $.gQ.Animation({	imageURL: "./img/battle/cvs/cvs_walk_backward_58x106x5.png",
									numberOfFrame: 5,
									delta: 58,
									rate:240,
									type: $.gQ.ANIMATION_HORIZONTAL | $.gQ.ANIMATION_CALLBACK}),
				deltaX: 0, deltaY: 0, width: 58, height: 106},
            {animation: new $.gQ.Animation({	imageURL: "./img/battle/cvs/cvs_punch_120x104x6.png",
									numberOfFrame: 6,
									delta: 120,
									rate:120,
									type: $.gQ.ANIMATION_HORIZONTAL | $.gQ.ANIMATION_CALLBACK}),
				deltaX: 0, deltaY: 2, width: 120, height: 104},
            {animation: new $.gQ.Animation({	imageURL: "./img/battle/cvs/cvs_kick_156x106x9.png",
									numberOfFrame: 9,
									delta: 156,
									rate:90,
									type: $.gQ.ANIMATION_HORIZONTAL | $.gQ.ANIMATION_CALLBACK}),
            ...
            {animation: new $.gQ.Animation({	imageURL: "./img/battle/cvs/cvs_hit_59x103x1.png",
            						rate: 720,
    ...
    var abobo = {
        ...
        position: 400,
        adversary: "#cvs",
        animations: [  {animation: new $.gQ.Animation({	imageURL: "./img/battle/abobo/abobo_idle_100x121x3.png",
									numberOfFrame: 3,
									delta: 100,
									rate:190,
									type: $.gQ.ANIMATION_HORIZONTAL | $.gQ.ANIMATION_CALLBACK}),
				  deltaX: 0, deltaY: 49, width: 100, height: 121},
                {animation: new $.gQ.Animation({	imageURL: "./img/battle/abobo/abobo_walk_forward_94x126x6.png",
									numberOfFrame: 6,
									delta: 94,
									rate:240,
									type: $.gQ.ANIMATION_HORIZONTAL | $.gQ.ANIMATION_CALLBACK}),
				   deltaX: 0, deltaY: 44, width: 94, height: 126},
                {animation: new $.gQ.Animation({	imageURL: "./img/battle/abobo/abobo_walk_backward_94x126x6.png",
									numberOfFrame: 6,
									delta: 94,
									rate:240,
									type: $.gQ.ANIMATION_HORIZONTAL | $.gQ.ANIMATION_CALLBACK}),
					deltaX: 0, deltaY: 44, width: 94, height: 126},
                {animation: new $.gQ.Animation({	imageURL: "./img/battle/abobo/abobo_punch_131x170x4.png",
									numberOfFrame: 4,
									delta: 131,
									rate:150,
									type: $.gQ.ANIMATION_HORIZONTAL | $.gQ.ANIMATION_CALLBACK}),
				  deltaX: -30, deltaY: 0, width: 131, height: 170},
                {animation: new $.gQ.Animation({	imageURL: "./img/battle/abobo/abobo_kick_137x130x2.png",
									numberOfFrame: 2,
									delta: 137,
									rate:500,
									type: $.gQ.ANIMATION_HORIZONTAL | $.gQ.ANIMATION_CALLBACK}),
				  deltaX: 20, deltaY: 40, width: 137, height: 130},
                {animation: new $.gQ.Animation({	imageURL: "./img/battle/abobo/abobo_block_81x130x1.png",
									rate:700,
                					type: $.gQ.ANIMATION_CALLBACK}),
	              deltaX: 0, deltaY: 40, width: 81, height: 130},
                {animation: new $.gQ.Animation({	imageURL: "./img/battle/abobo/abobo_hit_108x120x3.png",
									numberOfFrame: 3,
									delta: 108,
									rate:240,
									type: $.gQ.ANIMATION_HORIZONTAL | $.gQ.ANIMATION_CALLBACK}),
...
/*
		...
		// 主角後退
		else if ((cvsLeft > 200) && (cvsF.currentState == WALK_BACKWARD)){
            cvs.x(cvsLeft-2)
        }
*/
